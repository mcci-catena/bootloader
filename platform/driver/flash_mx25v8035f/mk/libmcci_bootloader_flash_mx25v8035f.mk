...
ifeq ($(_GUARD_libmcci_bootloader_flash_mx25v8035f.mk),)
_GUARD_libmcci_bootloader_flash_mx25v8035f.mk := 1	# prevent multiple includes.
...
endif # _GUARD_libmcci_bootloader_flash_mx25v8035f.mk
