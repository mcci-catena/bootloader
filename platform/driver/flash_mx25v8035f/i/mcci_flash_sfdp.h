...
///   @{
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NAND1_216D	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xF0)	///< NAND class 1 from JESD216D
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NAND2_216D	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xF1)	///< NAND class 2 from JESD216D
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NAND3_CLASS1_D	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xF2)	///< reserved for NOR + NAND1
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NAND3_CLASS2_D	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xF3)	///< reserved for NOR + NAND2
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NAND1_216B	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xF4)	///< NAND class 1 from JESD216B
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NAND2_216B	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xF5)	///< NAND class 2 from JESD216B
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NAND3_RSV1	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xF6)	///< reserved for NOR + NAND1
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NAND3_RSV2	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xF7)	///< reserved for NOR + NAND2
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_RSV248		MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xF8)	///< reserved
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_RSV249		MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xF9)	///< reserved
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NOR2		MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xFA)	///< NOR xSPI profile 2, 5-byte addressing SFDP cmd
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_RSV251		MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xFB)	///< reserved
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NOR1_3_8W	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xFC)	///< NOR xSPI profile 1, 3-byte, 8 wait
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NOR1_4_20W	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xFD)	///< NOR xSPI profile 1, 4 byte, 20 wait
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NOR1_4_8W	MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xFE)	///< NOR xSPI profile 1, 4 byte, 8 wait
#define	MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL_NOR		MCCI_BOOTLOADER_FIELD_SET_VALUE(MCCI_FLASH_SFDP_HEADER_PROPERTY_PROTOCOL, 0xFF)	///< Legacy NOR, JESD216B, 3-byte SFDP command w/ 8 wait states
///   @}
