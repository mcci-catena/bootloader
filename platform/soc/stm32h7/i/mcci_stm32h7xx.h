...
#define	MCCI_STM32H7_MEMORY_AXI_SRAM1	UINT32_C(0x24000000)	///< AXI SRAM1 (up to 256K)
#define	MCCI_STM32H7_MEMORY_AXI_SRAM2	UINT32_C(0x24040000)	///< AXI SRAM2 (up to 384K)
#define	MCCI_STM32H7_MEMORY_AXI_SRAM3	UINT32_C(0x240A0000)	///< AXI SRAM3 (up to 384K)
